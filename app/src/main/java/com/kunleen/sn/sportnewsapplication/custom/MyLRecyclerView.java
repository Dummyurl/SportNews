 ...
 */
public class MyLRecyclerView extends RecyclerView {
     ...
     * 当前RecyclerView类型
     */
    protected com.github.jdsjlzx.recyclerview.LRecyclerView.LayoutManagerType layoutManagerType;
    ...
    public MyLRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyLRecyclerView(Context context, AttributeSet attrs, int defStyle) {
            ...
            if (adapter instanceof LRecyclerViewAdapter) {
                ...
                if (lRecyclerViewAdapter.getInnerAdapter() != null && mEmptyView != null) {
                    ...
                    if (count == 0) {
                        ...
                        MyLRecyclerView.this.setVisibility(View.GONE);
                    } else {
                        mEmptyView.setVisibility(View.GONE);
                        MyLRecyclerView.this.setVisibility(View.VISIBLE);
                    }
                }
            } else {
    ...
    public void forceToRefresh(boolean noHeader) {
        if (mLoadingData) {
            return;
        }
        mRefreshListener.onRefresh();
    ...
    public void onScrolled(int dx, int dy) {
        ...
        if (layoutManagerType == null) {
            if (layoutManager instanceof LinearLayoutManager) {
                layoutManagerType = com.github.jdsjlzx.recyclerview.LRecyclerView.LayoutManagerType.LinearLayout;
            } else if (layoutManager instanceof GridLayoutManager) {
                layoutManagerType = com.github.jdsjlzx.recyclerview.LRecyclerView.LayoutManagerType.GridLayout;
            } else if (layoutManager instanceof StaggeredGridLayoutManager) {
                layoutManagerType = com.github.jdsjlzx.recyclerview.LRecyclerView.LayoutManagerType.StaggeredGridLayout;
            } else {
    ...
    public void hideFooterView(boolean isHide) {
        if (isHide) {
