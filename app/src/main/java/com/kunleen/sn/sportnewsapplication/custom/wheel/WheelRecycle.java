...
public class WheelRecycle {
    ...
    // Wheel view
    private com.kunleen.sn.sportnewsapplication.custom.wheel.WheelView wheel;
     ...
     */
    public WheelRecycle(com.kunleen.sn.sportnewsapplication.custom.wheel.WheelView wheel) {
        this.wheel = wheel;
    }
     ...
     */
    public int recycleItems(LinearLayout layout, int firstItem, com.kunleen.sn.sportnewsapplication.custom.wheel.ItemsRange range) {
        int index = firstItem;
